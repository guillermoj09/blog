                ...
                <div class="ibox ">
                    ...
                    <div>
                        <div class="ibox-content no-padding border-left-right">
                            <img alt="image" class="img-fluid" src="img/acerca/perfil.jpg" height="" width="">
                        </div>
                        <div class="ibox-content profile-content">
                            <h4><strong>Geraldine Alarcón Rojas</strong></h4>
                            <p><i class="fa fa-map-marker"></i> Arica, Chile 26/02/1971</p>
                            <h5>
                                About me
                            </h5>
                            <p>
